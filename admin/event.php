...
$dataEvent = [
    ...
    [
        ...
        "namaEvent" => "Himatro Business Outdoor",
        "kategori" => "Bazar",
        "harga" => "Rp 0",
        "tanggal" => "2025-12-20",
        ...
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Kategori</label>
                        <input type="text" id="edit_kategori" class="form-control" name="kategori">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Tanggal Pelaksanaan</label>
                        <input type="date" id="edit_tanggal" class="form-control" name="tanggal">
                    </div>
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="Rp. 20.000" class="form-control" readonly>
                    </div>

                    <div class="form-group">
                        <label>Tanggal Pemesanan</label>
                        <input type="text" id="bayar_aktif" value="26 November 2025" class="form-control" readonly>
                    </div>

                    <div class="form-group">
                        <label>Tanggal Selesai</label>
                        <input type="text" id="bayar_aktif" value="30 November 2025" class="form-control" readonly>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="konfirmasiBayar" class="btn btn-success">
                        <i class="fas fa-check"></i> Konfirmasi Sudah Dibayar
                    </button>
                </div>
